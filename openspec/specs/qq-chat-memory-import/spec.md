# qq-chat-memory-import Specification

## Purpose

Define the operator-owned QQ chat history import flow for converting trusted QQ exporter JSON files into raw MemOS conversation chunks without LLM review, approval state, or Agent-visible bulk import tools.
