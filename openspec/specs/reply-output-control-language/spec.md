...
Define the Output Control Language (OCL) that governs how assistant output is parsed into ordered segments, how inner thought is handled, and how guardrails protect delivery integrity.
