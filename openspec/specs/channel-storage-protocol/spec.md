...
Define the canonical Channel Key protocol, channel-first storage layout, manifest/catalog recovery, namespace ownership, safe path resolution, and no-migration boundary.
