...
- **WHEN** storage contains a legacy platform-message record
- **THEN** the new framework MUST NOT decode, render, or migrate that record
- **AND** deployment documentation MUST require prior history removal or replacement
